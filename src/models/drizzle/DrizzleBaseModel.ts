...
class DrizzleBaseModel {
  ...
  isValidSearch(search) {
    ...
    const validSearchQuery =
      typeof search.query === "string" && search.query.length > 0
  ...
  addQueryFilter(filter) {
    ...
    for (const field of fields) {
      if (allFields.includes(field)) {
        ...
        console.log(
          `invalid filter ${field} not exists in [${allFields.join(",")}]`,
        )
      }
    }
    // @ts-ignore
  ...
  async getRecordsWithSearch_withPage(
    orderBy,
    limit,
    offset,
    searchType,
  ...
  async getRecordsWithSearch_withFilter_withPage(
    orderBy,
    condition,
    limit,
    offset,
  ...
  async getRecordsWithSearch_with_filter(
    orderBy,
    condition,
    searchType,
    searchField,
  ...
  async getCountWithSearch_withFilter_withPage(
    condition,
    limit,
    offset,
    searchType,
  ...
  async getCountWithSearch_with_filter(
    condition,
    searchType,
    searchField,
    searchQuery,
  ...
  async getCountWithSearch_withPage(
    limit,
    offset,
    searchType,
    searchField,
  ...
  async getState(_limit = 5, _page = null, _filter = null, _search = null) {
    ...
    if (hasSearchAndFilter) {
      ...
      if (hasPage) {
        recordCount = await this.getCountWithSearch_withFilter_withPage(
          condition,
          limit,
          offset,
          searchType,
        ...
        recordCount = await this.getCountWithSearch_with_filter(
          condition,
          searchType,
          searchField,
          searchQuery,
      ...
      if (hasPage) {
        recordCount = await this.getCountWithSearch_withPage(
          limit,
          offset,
          searchType,
          searchField,
        ...
        recordCount = await this.getCountWithSearch(
          searchType,
          searchField,
          searchQuery,
        )
      ...
      if (hasPage) {
        // console.log("here")
        recordCount = await this.getCountWithFilter_withPage(
          limit,
          offset,
          condition,
        )
  ...
  async getList(
    ...
    if (hasSearchAndFilter) {
      ...
      if (hasPage) {
        records = await this.getRecordsWithSearch_withPage(
          orderBy,
          limit,
          offset,
          searchType,
        ...
        records = await this.getRecordsWithSearch(
          orderBy,
          searchType,
          searchField,
          searchQuery,
      ...
      if (hasPage) {
        // console.log("here")
        records = await this.getRecordsWithFilter_withPage(
          orderBy,
          limit,
          offset,
          // @ts-ignore
